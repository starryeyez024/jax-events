...
const SCHEDULES: Schedule[] = [
  {
    id: "sun-hanna-park",
    title: "Sunrise Yoga at Hanna Park",
    weekday: 0,
    time: "07:00",
    durationMin: 60,
    ...
    city: "Jacksonville",
    url: "https://www.jacksonville.gov/departments/parks-and-recreation/jaxparks",
    description:
      "Free weekly sunrise yoga at the beach. The class itself is free, but Hanna Park charges $5 per vehicle at the gate.",
    price: 5,
  ...
  },
  {
    ...
    title: "Free Yoga at Friendship Fountain (First Thursday)",
    weekday: 4,
    time: "19:00",
    durationMin: 60,
    ...
    city: "Jacksonville",
    url: "https://jaxparks.coj.net/",
    description: "Free monthly yoga at Friendship Fountain, first Thursday of each month.",
    price: 0,
    categories: ["yoga", "health-wellness", "outdoor-nature"],
