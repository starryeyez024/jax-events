...
export default function Home() {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 md:px-8 pb-8 pt-6">
      ...
      >
        {/* No sticky, no height cap, no inner scroller. Pinning the panel
            meant capping its height to the viewport and giving it its own
            overflow, and that scroll region kept failing: unreachable on
            mobile, and still short of the bottom on desktop. A panel that
            simply scrolls with the page has none of those failure modes, and
            the collapse toggle is what the pinning existed to keep reachable
            anyway. overflow-x stays to clip the width animation. */}
        <aside
          className={`shrink-0 overflow-x-hidden transition-[width] duration-300 ease-out motion-reduce:transition-none w-full ${
